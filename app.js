...
app.get("/user-dashboard/:userId/vendor-enquiries", sessionCheck, async function (req, res) {
    ...
    let enquiries
    try {
        enquiries = await UserDashboard.find({});
    } catch (err) {
        console.log(err);
    }
...
app.get("/venue-dashboard/:venueId", venueSessionCheck, async function (req, res) {
    ...
    try {
        active = await VenueDashboard.findOne({ accepted: true });
    } catch (err) {
        console.log(err);
    }

    try {
        number_2 = await VenueDashboard.find({ accepted: true });
    } catch (err) {
        console.log(err);
    }
...
app.get("/venue-dashboard/:venueId/active-events", venueSessionCheck, async function (req, res) {
    ...
    let enquiries;
    try {
        enquiries = await VenueDashboard.find({});
    } catch (err) {
        console.log(err);
    }
...
app.get("/vendor-dashboard/:vendorId", vendorSessionCheck, async function (req, res) {
    ...
    try {
        active = await VendorDashboard.findOne({ accepted: true });
    } catch (err) {
        console.log(err);
    }

    try {
        enquirie = await VendorDashboard.findOne({ accepted: false });
    } catch (err) {
        console.log(err);
    }
...
app.get("/vendor-dashboard/:vendorId/active-events", vendorSessionCheck, async function (req, res) {
    ...
    let enquiries;
    try {
        enquiries = await VendorDashboard.find({});
    } catch (err) {
        console.log(err);
    }
